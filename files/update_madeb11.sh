...
# Mise à jour du repertoire ansible madeb 11
## Dépendance
...
## Version actuelle
OLD_VERSION=$(head -1 /opt/ansible/madeb11/Version.txt 2>/dev/null)
## Version nouvelle : la dernière
### Dépot Github
repoGit="cpunivangers/madeb11"
...
sudo tar -xzf /tmp/madeb.tar.gz -C /opt/ansible/ --one-top-level=madeb11 --strip-components 1
...
echo "$VERSION" > /opt/ansible/madeb11/Version.txt
